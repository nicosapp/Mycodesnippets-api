  ...
  public function __invoke(Request $request)
  {
    if (Auth::check()) {
      return SnippetLightResource::collection(
        Snippet::withScopes($this->scopes())->latest('updated_at')->paginate(Snippet::$pagination)
      );
    }
    return SnippetLightResource::collection(
      Snippet::withScopes($this->scopes())->orWhere('is_public', true)->latest('updated_at')->paginate(Snippet::$pagination)
    );
  }
